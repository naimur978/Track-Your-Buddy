package com.naimur978.trackyourbuddy.trackyourbuddy.fragment;
...
import com.naimur978.trackyourbuddy.trackyourbuddy.activity.AllFriendsLocationActivity;
import com.naimur978.trackyourbuddy.trackyourbuddy.activity.FriendLocationActivity;
import com.naimur978.trackyourbuddy.trackyourbuddy.other.Contact;
import com.naimur978.trackyourbuddy.trackyourbuddy.other.ContactViewHolder;
import com.naimur978.trackyourbuddy.trackyourbuddy.other.ContactsAdapter;
import com.naimur978.trackyourbuddy.trackyourbuddy.other.ItemClickSupport;
...
public class FriendsFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ItemClickSupport.addTo(mRecyclerView).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                ...
                Intent intent = new Intent(getActivity(), FriendLocationActivity.class);
                intent.putExtra("mobile_no", holder.mTextViewMobileNo.getText().toString());
                intent.putExtra("name", holder.mTextViewName.getText().toString());
    ...
    private void getContactsList() {
        ...
        while (contacts.moveToNext()) {
            ...
            if (mobileNo.length() > 17 /*&& mobileNo.charAt(0) == '0'*/) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_item_show_all:
                Intent intent = new Intent(getActivity(), AllFriendsLocationActivity.class);
